       ...
       <View className="w-full">
          <View className=" flex-row rounded-b-[3rem] overflow-hidden">
            <LinearGradient
              ...
              style={{ flex: 1 }}
            >
              <TouchableOpacity onPress={() => router.back()} className=" bg-white/50 rounded-full  flex-row  items-center  h-auto  p-1.5">
          ...
          >
            <View className="pl-2">
              <SearchIcon size={20} className="text-white" color={"#fff"} />
            </View>
        ...
        <View className="flex-row justify-between items-center mt-4 mb-2 px-4">
          <View>
         <Text className="text-gray-600 font-semibold">4 Eventos encontrados</Text>
          </View>
          <View className="flex-row gap-2">
                <TouchableOpacity activeOpacity={1} onPress={() => setGridOrList(true)} className={` ${gridOrList === false ? 'bg-gray-200/50' : 'bg-indigo-500'}  flex-row  items-center rounded-full border h-auto mt-3 px-4 py-2 overflow-hidden border-gray-200 `}>
                <LayoutGrid size={20} color={gridOrList === false ? "#000" : "#ffffff"} />
              </TouchableOpacity>
                   <TouchableOpacity activeOpacity={1} onPress={() => setGridOrList(false)}  className={` ${gridOrList === true ? 'bg-gray-200/50' : 'bg-indigo-500'}  flex-row  items-center rounded-full border h-auto mt-3 px-4 py-2 overflow-hidden border-gray-200 `}>
                <List size={20} color={gridOrList === true ? "#000" : "#ffffff"} />
              </TouchableOpacity>
          </View>
        </View>
