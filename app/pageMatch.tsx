  ...
  return (
    <View className="flex-1 ">
      ...
      <View className="flex-1 w-full h-96 relative z-0">
        ...
        />
        <View className="w-full h-80 justify-center items-center overflow-hidden absolute bottom-0"> <LinearGradient
          style={{
            position: "absolute",
            width: "100%",
            height: "100%",
          ...
          <View className="w-full h-40 justify-start items-start p-3 absolute bottom-40 ">
            ...
            <View className="relative z-40 pt-2">
              <Text className="text-white text-base font-semibold ">
                Software developer. Love music and tech events. Always up for a
                good time!
              </Text>
            </View>
            <View className="flex-row gap-3 relative z-30 pt-2">
              <View className="bg-white/20 rounded-full justify-center items-center px-3 py-1">
                <Text className="text-white text-sm font-semibold">Vinhos</Text>
              </View>
              <View className="bg-white/20 rounded-full justify-center items-center px-3 py-1">
                <Text className="text-white text-sm font-semibold ">Musicas</Text>
              </View>
              <View className="bg-white/20 rounded-full justify-center items-center px-3 py-1">
                <Text className="text-white text-sm font-semibold">Praia</Text>
              </View>
              <View className="bg-white/20 rounded-full justify-center items-center px-3 py-1">
                <Text className="text-white text-sm font-semibold">Livros</Text>
              </View>
            </View>
          </View>
        </View>
